...
import PostPoemScreenWeb from '../screens/PostPoemScreenWeb';

const HomeRootsNavigator = props => {
      ...
      {OS === 'web' ? (
        <>
          <Stack.Screen
            ...
            options={{ headerTitle: 'DNJ' }}
          />
          <Stack.Screen
            name="PostPoemScreenWeb"
            component={PostPoemScreenWeb}
          />
        </>
      ) : (
        <Stack.Screen name="poems" component={BottomTabs} />
      )}
...
export default withTheme(HomeRootsNavigator);
